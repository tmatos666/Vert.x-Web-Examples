 ...
 * @author ISEP
 */
public class FreeMarkerWithJavaScript extends AbstractVerticle {

    // Convenience method so you can run it in your IDE
    public static void main(String[] args) throws Exception {
        //Runner.runExample(Server.class);
        io.vertx.core.Launcher l = new Launcher();
        l.execute("run", "com.mycompany.mavenproject1.FreeMarkerWithJavaScript");
    }
    ...
    public void exampleURLGET(RoutingContext ctx) {
        ...
        engine.render(ctx, "templates/exampleJavaScript.ftl", res -> {
            if (res.succeeded()) {
